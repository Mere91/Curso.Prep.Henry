...
function tienenMismaLongitud(str1, str2) { if(str1.length==str2.length) return true;return false;  // Devuelve "true" si las dos strings tienen la misma longitud
  // De lo contrario, devuelve "false"
  // Tu código:
}
...
function obtenerResto(x, y) { return x % y;  // Obten el resto de la división de "x" entre "y"
  // Tu código:
}
...
function elevarAlCuadrado(num) {return num*num // Devuelve el valor de "num" elevado al cuadrado
